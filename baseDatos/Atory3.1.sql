...
CREATE TABLE `factura` (
  ...
  KEY `fk_factura_plan` (`plan_idPlan`),
  CONSTRAINT `factura_ibfk_1` FOREIGN KEY (`cliente_idCliente`) REFERENCES `cliente` (`idCliente`),
  CONSTRAINT `fk_factura_plan` FOREIGN KEY (`plan_idPlan`) REFERENCES `plan` (`idPlan`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AVG_ROW_LENGTH=45;

/*Data for the table `factura` */

insert  into `factura`(`idFactura`,`fechaFactura`,`impuestoTotal`,`subTotal`,`valorTotalFactura`,`cliente_idCliente`,`estadoFactura`,`plan_idPlan`) values (1,'2023-05-17',10000,50000,60000,1,'Pago',1),(2,'2023-05-17',15000,60000,75000,2,'pago',2),(3,'2023-05-17',50000,500000,550000,3,'Pago',3),(4,'2023-05-16',30000,200000,130000,4,'Pago',2),(6,'2023-03-12',7000,15000,22000,13,'Pendiente',2),(7,'2023-04-12',6000,21000,27000,13,'Pendiente',1),(8,'2023-05-12',6000,15000,21000,13,'Pendiente',2),(9,'2023-02-12',5000,15000,20000,13,'Pendiente',4),(10,'2023-05-22',70000,350000,420000,4,'Pago',5),(11,'2023-02-13',7000,25000,32000,13,'Pendiente',2),(12,'2023-06-29',20000,20000,40000,1,'Pago',1),(15,'2023-01-09',6000,45000,51000,5,'Pendiente',1),(17,'2023-03-30',90000,450000,54000,7,'Pendiente',1),(18,'2023-02-10',100000,500000,600000,14,'Pendiente',1),(19,'2022-12-17',50000,250000,30000,15,'Pendiente',1),(21,'2022-11-25',85000,225000,310000,18,'Pendiente',1),(22,'2023-01-18',6000,30000,36000,17,'Pendiente',1),(25,'2023-03-09',20000,75000,95000,19,'Pendiente',1),(26,'2023-06-18',15000,75000,90000,19,'Pendiente',1),(27,'2023-06-30',7000,30000,37000,19,'Pendiente',1),(28,'2024-02-05',50000,150000,200000,7,'Pendiente',1);
