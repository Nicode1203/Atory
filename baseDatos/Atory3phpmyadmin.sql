...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-02-2024 a las 18:22:56
...
INSERT INTO `cliente` (`idCliente`, `tipoDocumento`, `documentoCliente`, `nombreCliente`, `telefonoCliente`, `correoCliente`, `direccion`, `estadoCliente`, `creado`, `ultimaActualizacion`, `plan_idPlan`) VALUES
(1, 'C.C', '1055325484', 'Arnulfo Rodriguez', '3005554878', 'arnulfo@gmail.com', 'cll 148 # 98-41', 'Archivado', '2023-05-12', '2023-05-17', 1),
(2, 'C.C', '1030525484', 'Blanca Cordero', '3008562013', 'blanca@gmail.com', 'cr 5 #148 -13', 'Activo', '2023-05-18', '2023-05-18', 2),
(3, 'C.C', '1035585487', 'Carolina Crosby', '3122254858', 'caro@gmail.com', 'cll 89 sur # 45-48', 'Activo', '2023-05-17', '2023-05-17', 2),
(4, 'C.C', '9587458', 'Diana Borges', '3103404090', 'diana@gmail.com', 'cr 2 # 98-74', 'Activo', '2023-05-17', '2023-05-17', 2),
(5, 'C.C', '1025859658', 'Ernesto Gutierrez', '3203103525', 'ernie@gmail.com', 'cll 45 # 10-47', 'Archivado', '2023-06-01', '2023-06-04', 2),
(6, 'C.C', '2121', 'Carlos Schick', '300300300', 'lkaro@gmail.com', 'cll 5#98-45', 'Activo', '2023-01-02', '2023-05-16', 1),
(7, 'C.C', '123', 'Mariana Borda', '3236587979', 'Mariana@hotmail.com', 'cr 23 # 125-66', 'Archivado', '2023-03-01', '2023-03-02', 1),
(8, 'C.C', '2365', 'Ayane Hayabusa', '878965412', 'ayane@hotmail.com', 'cll 123# 78-41', 'Activo', '2023-01-10', '2023-06-07', 1),
(9, 'C.E', '9863', 'Isabella Montana', '9547893652', 'isabella@gmail.com', 'cll 127 # 98-85', 'Activo', '2022-01-04', '2023-01-10', 1),
(10, 'C.E', '58944444', 'Maria Reyes', '3231039856', 'maria.r@gmail.com', 'cll 145 # 108-63', 'Activo', '2022-07-08', '2023-03-17', 3),
(11, 'C.C', '698', 'Yolanda Tellez', '3216549898', 'y.165@aol.com', 'cll159#10-29', 'Activo', '2023-06-10', '2023-06-18', 4),
(12, 'C.E', '56', 'Tina Lovecraft', '9548961245', 'tina@gmail.com', 'cll 36#69-89', 'Activo', '2023-04-05', '2023-06-06', 3),
(13, 'C.C', '1012151563', 'Gabriela Castiblanco', '3103656989', 'gaby@hotmail.com', 'km 5 via cota chia', 'Activo', '2023-04-11', '2023-05-28', 3),
(14, 'C.C', '789', 'Ana Maria Rosales', '7893652123', 'maria@gmail.com', 'cll 13#140-75', 'Activo', '2023-06-23', '2023-06-23', 2),
(15, 'C.C', '2024', 'juanito alimaña', '300886644', 'alimana@gmail.com', 'cll 34 # 20 20', 'Activo', '2024-01-24', '2024-01-24', 7);
...
INSERT INTO `factura` (`idFactura`, `fechaFactura`, `impuestoTotal`, `subTotal`, `valorTotalFactura`, `cliente_idCliente`, `estadoFactura`) VALUES
(1, '2023-05-17', 10000, 50000, 60000, 1, 'Pago'),
(2, '2023-05-17', 15000, 60000, 75000, 2, 'pago'),
(3, '2023-05-17', 50000, 500000, 550000, 3, 'Pago'),
(4, '2023-05-16', 30000, 200000, 130000, 4, 'Pago'),
(6, '2023-03-12', 7000, 15000, 22000, 5, 'Pendiente'),
(7, '2023-04-12', 6000, 21000, 27000, 6, 'Pendiente'),
(8, '2023-05-12', 6000, 15000, 21000, 7, 'Pendiente'),
(9, '2023-02-12', 5000, 15000, 20000, 8, 'Pendiente'),
(10, '2023-05-22', 70000, 350000, 420000, 9, 'Pago'),
(11, '2023-02-13', 7000, 25000, 32000, 10, 'Pendiente'),
(12, '2023-06-29', 20000, 20000, 40000, 11, 'Pago'),
(15, '2023-01-09', 6000, 45000, 51000, 12, 'Pendiente'),
(17, '2023-03-30', 90000, 450000, 54000, 13, 'Pendiente'),
(18, '2023-02-10', 100000, 500000, 600000, 14, 'Pendiente'),
(19, '2022-12-17', 50000, 250000, 30000, 15, 'Pendiente'),
(21, '2022-11-25', 85000, 225000, 310000, 1, 'Pendiente'),
(22, '2023-01-18', 6000, 30000, 36000, 2, 'Pendiente'),
(25, '2023-03-09', 20000, 75000, 95000, 3, 'Pendiente'),
(26, '2023-06-18', 15000, 75000, 90000, 4, 'Pendiente'),
(27, '2023-06-30', 7000, 30000, 37000, 5, 'Pendiente'),
(28, '2024-02-05', 50000, 150000, 200000, 6, 'Pendiente');
...
(1, '1', 'rural', '20mb', 'Plan economico', 50000, 'Plan económico de 20mb para la cuidad adecuada para casa pequeñas', 'Archivado'),
...
(6, '6', 'empresarial', '150 mb', 'Plan elite empresa', 150000, 'Plan para empresas grande que requieran excelente velocidades de wifi, viene con fibra óptica', 'Archivado'),
...
(1, 'C.C', '806554878', 'Karl', '3103209913', 'karl@gmail.com', '123456', 'Activo', '2023-05-09', '2023-05-09', 'Administrador'),
(2, 'C.C', '1023554584', 'cris', '3017328804', 'cristian@hotmail.com', '123456', 'Activo', '2023-05-10', '2023-05-10', 'Administrador'),
(3, 'CC', '1030634046', 'nico', '3006646485', 'nico@gmail.com', '123456', 'Activo', '2023-05-12', '2023-05-12', 'Administrador'),
(4, 'C.C', '1020554483', 'Fabian', '3104552020', 'fabiancho@aol.com', '123456', 'Inactivo', '2023-05-12', '2023-05-12', 'Administrador'),
(5, 'C.C', '23568985', 'Isa', '3215698787', 'isabella@hotmail.com', '123456', 'Activo', '2023-11-05', '0223-11-05', 'Tecnico'),
(6, 'C.C', '1234', 'Danny', '3198562323', 'danny@gmail.com', '123456', 'Activo', '2023-11-06', '0223-11-06', 'Tecnico');
...
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `fk_cliente_factura` FOREIGN KEY (`idCliente`) REFERENCES `factura` (`cliente_idCliente`),
