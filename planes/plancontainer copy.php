        ...
        <div class="row">
          ...
          <div class="card" style="background-color: #ffffff; border-radius: 20px;">
              <div class="card-body text-dark">
                <h4 class="card-title text-dark"><?php echo "$nplan" ?></h4>
                <img src="../assets/images/lockscreen-bg.jpg" alt="Descripción de la imagen" class="card-img-top" style="border-radius: 20px 20px 0 0;">
